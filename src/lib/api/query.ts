...
export const keys = {
  ...
  classroomJoinCode: (userId: string, id: string) => ['user', userId, 'classroom', id, 'join-code'] as const,
  classroomJoinRequests: (userId: string, id: string) => ['user', userId, 'classroom', id, 'join-requests'] as const,
  ...
  myClassrooms: (userId: string) => ['user', userId, 'my-classrooms'] as const,
  myClassroomJoinRequests: (userId: string) => ['user', userId, 'my-classroom-join-requests'] as const,
  mySessionJoinRequests: (userId: string) => ['user', userId, 'my-session-join-requests'] as const,
