...
export function InstructorHome() { return <><header className="page-heading"><p className="eyebrow">Instructor workspace</p><h1>Bring ideas into practice.</h1><p>Open your classroom session or explore the available simulation models.</p></header><OpenSession/><ModelCatalog/><section className="notice"><h2>Your classroom resources</h2><p>Use Scenarios to discover and author your owned drafts, published versions, and archived resources.</p></section></>; }
